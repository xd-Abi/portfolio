    ...
    <div className="flex min-h-screen text-white bg-black overflow-x-hidden">
      <div className="basis-full flex items-center justify-center">
        ...
        <div className="relative text-center">
          <div className="filter blur-3xl opacity-80 animate-blob absolute w-52 h-52 -left-12 bg-purple-900 rounded-full"></div>
          <div className="filter blur-3xl opacity-80 animate-blob absolute w-52 h-52 left-32 bg-red-600 rounded-full"></div>
          <div className="filter blur-3xl opacity-80 animate-blob absolute w-52 h-52 -left-2 -top-24 bg-pink-900 rounded-full"></div>
          <div className="relative">
            <p className="font-sans font-semibold text-gray-400">
              Welcome, I am
            </p>
            <p className="pt-2 font-sans font-bold text-6xl">xd Abi.</p>
          </div>
        </div>
      </div>
    </div>
